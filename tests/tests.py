...
class TestAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson3 = Lesson.objects.create(
            course=self.course,
            title='Урок 3 (с неактивным тестом)',
            owner=self.teacher1,
            order=3
        )
        ...
        self.answer1_1 = AnswerOption.objects.create(
        ...
        self.answer1_2 = AnswerOption.objects.create(
            question=self.question1,
            text='4',
            is_correct=True,
            order=2
        ...
        self.answer2_1 = AnswerOption.objects.create(
        ...
        self.answer2_2 = AnswerOption.objects.create(
            question=self.question2,
            text='3',
            is_correct=False,
            order=2
        ...
        self.answer2_3 = AnswerOption.objects.create(
            question=self.question2,
            text='4',
            is_correct=True,
            order=3
